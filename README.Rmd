...
If you're stumbling into the world of Dataset JSON, you might be wondering "Why JSON?", as many have asked this question. We highly recommend you take a pit stop to read [this blog post](https://humedatalabs.com/why-json-for-datasets/) by Sam Hume one of the creators of the Dataset JSON standard. 

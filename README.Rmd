...
To attach necessary metadata (that can't be inferred by the input dataframe or at time or write) to the `datasetjson` object, you can use a variety of setter functions:

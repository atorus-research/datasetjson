test_df <- data.frame(
  ...
  dt1 = as.POSIXct(((19916:19926)  + (365 * 10)) * 24 * 60 * 60 + (2 * 60 * 60) + (45 * 60) + 20)
)

check_df <- test_df
check_df[1:2] <- check_df[1:2] - (365 * 10)
check_df[3:4] <- check_df[3:4] - (365 * 10* 24 * 60 * 60)
